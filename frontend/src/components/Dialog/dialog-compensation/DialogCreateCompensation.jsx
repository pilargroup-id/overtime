...
function DialogCreateCompensation({
  isOpen = false,
  eyebrow = 'Create Compensation Type',
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setErrorMessage(error?.message || 'Gagal membuat compensation type.')
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  const dialogNode = (
    ...
    >
      <form
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-create-compensation-type-title"
      ...
      >
        <div className="dashboard-popup__header">
          <div>
            ...
            <h2 className="dashboard-popup__title" id="dialog-create-compensation-type-title">
              {title}
            </h2>
          </div>
              ...
              <div className="register-user-popup__form">
                <div className="register-user-popup__grid">
                  ...
                  <div className="register-user-popup__field overtime-create-popup__field--half">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-name"
                    >
                      Name
                    </label>
                    <input
                      id="create-compensation-name"
                      name="name"
                      type="text"
                      className="register-user-popup__input"
                  ...
                  <div className="register-user-popup__field overtime-create-popup__field--half">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-kind"
                    >
                      Compensation Kind
                    </label>
                    <select
                      id="create-compensation-kind"
                  ...
                  <div className="register-user-popup__field overtime-create-popup__field--half">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-status"
                    >
                      Status
                    </label>
                    <select
                      id="create-compensation-status"
                      name="is_active"
                      className="register-user-popup__select"
                  ...
                  <div className="register-user-popup__field overtime-create-popup__field--half">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-amount"
                    >
                      Amount
                    </label>
                    <input
                  ...
                  <div className="register-user-popup__field overtime-create-popup__field--half">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-leave-days"
                    >
                      Leave Days
                    </label>
                    <input
                      id="create-compensation-leave-days"
                      name="leave_days"
                      type="number"
                      min="0"
                      step="0.5"
                  ...
                  <div className="register-user-popup__field register-user-popup__field--full">
                    <label
                      className="register-user-popup__label"
                      htmlFor="create-compensation-description"
                    >
                      Description
                    </label>
                    <textarea
                      id="create-compensation-description"
                      name="description"
...
export default DialogCreateCompensation
